...
public class MybatisTest {
	...
	@Ignore
	@Test
	public void getdpListTest() {
		List<Department> departments = departmentMapper.getDpList();
	...
	@Test
	public void foodsInsert() {
		Foods f = new Foods(2, "스테이크", 15500);
		assertEquals(1, foodsMapper.foodsInsert(f));
	}
